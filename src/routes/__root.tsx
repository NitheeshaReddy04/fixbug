...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Fixbug — AI error explainer for developers" },
      { name: "description", content: "Paste any error. Know exactly why it happened, and how to fix it." },
      { name: "author", content: "Fixbug" },
