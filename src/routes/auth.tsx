            ...
            <Field label="Password">
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-border bg-input px-3 py-2 pr-10 text-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/30"
                />
                <button
                  type="button"
